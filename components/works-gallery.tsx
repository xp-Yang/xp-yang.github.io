  ...
  return (
    <>
        ...
        {items.map((item, index) => (
          <article key={item.id}>
            ...
            >
              ...
              >
                {item.cover && <img src={item.cover} alt="" className="absolute inset-0 h-full w-full object-cover" style={item.slug === 'schwarzschild-event-horizon' ? { objectPosition: '50% 45%' } : undefined} />}
                {item.placeholder && (
      ...
      {opening && (
        ...
        >
          {opening.item.cover && <img src={opening.item.cover} alt="" className="absolute inset-0 h-full w-full object-cover" style={opening.item.slug === 'schwarzschild-event-horizon' ? { objectPosition: '50% 45%' } : undefined} />}
          <div
