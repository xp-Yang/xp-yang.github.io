...
const FILES=["index.html","manifest.webmanifest","src/app.js","src/assets.js","src/chart-levels.js","src/engine.js","src/level3.js","src/level4.js","src/level8.js","src/level9.js","src/levels.js","src/mobile.js","src/portrait-colors.js","src/quality.js","src/render.js","src/runtime.js","src/sound.js","src/style.css","src/viewport.js","assets/settings.png","assets/energy.png","assets/coin.png","assets/close.png","assets/start-button.png","assets/free.png","assets/pattern-1.png","assets/pattern-2.png","assets/pattern-3.png","assets/pattern-4.png","assets/pattern-5.png","assets/pattern-6.png","assets/pattern-7.png","assets/pattern-8.png","assets/pattern-9.png","assets/background.png","assets/trophy.png","assets/clock.png","assets/pin.png","assets/locked-tools.png","assets/expand.png","assets/hand.png","assets/win-title.png","assets/rewards.png","assets/double-button.png","assets/pig.png","assets/entry-dialog.png","assets/load.png","assets/pick.wav","assets/place.wav","assets/win.wav","assets/apple-touch-icon.png","assets/app-icon-192.png","assets/app-icon-512.png"],BASE=new URL('./',self.location.href),PREFIX='pindou-ios-'+encodeURIComponent(BASE.pathname)+'-',VERSION=PREFIX+"037fd23ea5f9e0c6";
